...
#### Advanced Hands-Free Voice Commands
...
This application requires secure API keys to function. Create a file named `.env` in the root directory of the project. Add your Gemini and Picovoice keys to the file:
...
**Step 5. Configure your API Keys inside the App**
...
<table>
  <tr>
    <td align="center">
      <b>1. Starting Screen</b><br>
      <img src="screenshots/start.png" width="350"/>
    </td>
    <td align="center">
      <b>2. Main Menu</b><br>
      <img src="screenshots/mainmenu.png" width="350"/>
    </td>
  </tr>
  <tr>
    <td align="center">
      <b>3.Exam tools</b><br>
      <img src="screenshots/examtools.png" width="350"/>
    </td>
    <td align="center">
      <b>4. Exam Info Screen</b><br>
      <img src="screenshots/examinfo.png" width="350"/>
    </td>
  </tr>
  <tr>
    <td align="center">
      <b>5. Exam Screen</b><br>
      <img src="screenshots/examscreen.png" width="350"/>
    </td>
    <td align="center">
      <b>6. Individual Question Screen</b><br>
      <img src="screenshots/individualquestion.png" width="350"/>
    </td>
  </tr>
  <tr>
    <td align="center">
      <b>7. PDF Screen</b><br>
      <img src="screenshots/pdfscreen.png" width="350"/>
    </td>
    <td align="center">
      <b>7. View PDF </b><br>
      <img src="screenshots/pdf.png" width="350"/>
    </td>
  </tr>
</table>
