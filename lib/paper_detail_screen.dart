...
<<<<<<< HEAD
  ...
  if (!_sttService.isAvailable) {
    widget.ttsService.speak("Speech recognition not available.");
    return;
  }
  ...
  await _sttService.startListening((text) {
    setState(() {
      // Save dictated text to the current question
...
TextField(
  ...
  onChanged: (val) {
    widget.question.answer = val; // Keep updated if user types
  },
  maxLines: null,
...
// ✅ STT ADDITION: Start/Stop Dictation Button
ElevatedButton.icon(
  onPressed: _isListening ? _stopListening : _startListening,
  icon: Icon(_isListening ? Icons.mic_off : Icons.mic),
  label: Text(_isListening ? "Stop Dictation" : "Start Dictation"),
  style: ElevatedButton.styleFrom(
